...
from semantic_mining import (
    ...
    fold_proteins, filter_proteins_by_threshold
)
...
class Config:
    ...
    output_folds_file: str # CSV containing folds and sequence information for all protein sequences folded using ESMFold
...
def process_sequences(
    ...
    # Read prompts
    prompt_seqs = read_prompts(
        config.input_prompts,
        config.batched,
        config.batch_size
    )
    ...
    final_sequences = get_rc(
        sequences,
        rc_truth=config.rc_truth,
        return_both=config.return_both
    )
