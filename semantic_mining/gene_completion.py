...
from semantic_mining import (
    ...
    run_prodigal,filter_protein_fasta
)
...
class Config:
    ...
    evo_gen_seqs_file_save_location: str    # CSV continaing sequences generated by Evo and corresponding prompts
    ...
    msa_filtered_proteins_fasta: str # FASTA containing protein sequences that pass aligment against reference sequences
    ...
    output_summary_csv: Path # CSV containing summary statistics about overall sequence identities for all prompts
...
def make_gene_completion_fasta(sequences: List[str], prompts: List[str], ids: List[str], output_file: Path) -> None:
    """
...
def calculate_non_prompt_sequence_identity(input_aa: str, reference_aa: str, prompt_dna: str, mafft_path: str = "mafft") -> float:
    """
