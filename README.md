...
| `evo-1-phase-2`   | A model pretrained with 131,072 context using `evo-1-phase-1` as the base model. We use this model to reason about and generate sequences at the genome scale. |
