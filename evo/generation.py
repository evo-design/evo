...
if __name__ == '__main__':
    device = 'cuda:0'
    ckpt_path = '/checkpoint/etnguyen/7b_striped_120k/global_step75000/'
    n_tokens_to_generate = 256

    model, tokenizer = load_checkpoint(ckpt_path, 'stripedhyena')
    ...
    #    model,
    #    tokenizer,
    #    n_tokens=n_tokens_to_generate,
    #    source_repository='stripedhyena',
    #    temperature=1.,
    #    top_k=4,
    #    top_p=1.,
    #    verbose=1,
